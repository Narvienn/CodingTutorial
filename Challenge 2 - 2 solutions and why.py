...
flight_time = 180 # a list of flight lengths in minutes
...
def solution(films, target):  # O(n*n)
    for index1, f1 in enumerate(films): # enumerate: built-in function that returns counter? + value of item in list
